    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('winning_team', models.TextField(choices=[('0', 'Empty'), ('1', 'Legion'), ('2', 'Hellbourne')], default='0', max_length=1)),
                ('parsed_level', models.TextField(choices=[('1', 'FETCHED'), ('2', 'API'), ('3', 'REPLAY')], default='1', max_length=1)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('team', models.TextField(choices=[('0', 'Empty'), ('1', 'Legion'), ('2', 'Hellbourne')], default='0', max_length=1)),
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='matches', to='account.account')),
                ('hero', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='game_data.hero')),
                ('match', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='match.match')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
